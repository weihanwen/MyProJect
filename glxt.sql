...
INSERT INTO `sys_menu` VALUES ('6', 'w', '#', '0', '1', null, '');
INSERT INTO `sys_menu` VALUES ('7', '测试', 'w/list.do', '6', '1', null, '');
...
INSERT INTO `sys_role` VALUES ('3e6a9c1a13824b0990d13739fcbc3b09', '信息管理成员', '230', '1', '', '', '192', '192', '3e6a9c1a13824b0990d13739fcbc3b09');
...
-- ----------------------------
-- Table structure for `tb_oilcard`
-- ----------------------------
DROP TABLE IF EXISTS `tb_oilcard`;
CREATE TABLE `tb_oilcard` (
  `onlycard_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for `tb_oilorder`
-- ----------------------------
DROP TABLE IF EXISTS `tb_oilorder`;
CREATE TABLE `tb_oilorder` (
  `oilorder_id` varchar(100) NOT NULL,
  `oilcard_number` varchar(100) DEFAULT NULL,
  `money` double(11,2) DEFAULT NULL,
  `order_status` varchar(4) DEFAULT NULL,
  `remarks` text,
  `oiluser_id` varchar(100) DEFAULT NULL,
  `transaction_no` varchar(100) DEFAULT NULL COMMENT '流水单号',
  `arsid` varchar(10) DEFAULT NULL,
  `timestamp` varchar(100) DEFAULT NULL,
  `channel` varchar(100) DEFAULT NULL,
  `createtime` datetime DEFAULT NULL,
  `updatetime` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `jiami_message` text,
  PRIMARY KEY (`oilorder_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tb_oilorder
-- ----------------------------

-- ----------------------------
-- Table structure for `tb_oiluser`
-- ----------------------------
DROP TABLE IF EXISTS `tb_oiluser`;
CREATE TABLE `tb_oiluser` (
  `oiluser_id` varchar(100) NOT NULL,
  `wx_openid` varchar(100) DEFAULT NULL,
  `access_token` text,
  `createtime` datetime DEFAULT NULL,
  PRIMARY KEY (`oiluser_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
