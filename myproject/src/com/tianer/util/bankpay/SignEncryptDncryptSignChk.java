...
public class SignEncryptDncryptSignChk {
	...
	public static String wxpayurl="http://wxpay.cmbc.com.cn/mobilePlatform/cmbcPayweb.do?context=";
	
	public static String platformId="A00002016120000000294";//民生银行为接入平台分配的平台编号,与平台证书一一对应
	public static String merchantNo="M01002016090000001273";//该订单对应的民生统一商户号
	public static String merchantName="石油测试";// 商户名称，用于在民生页面回显
 	public static String defaultTradeType="API_WXQRCODE";//类型代码：API_WXQRCODE
	public static String selectTradeType="H5_WXJSAPI";//类型代码：H5_WXJSAPI
	public static String nowip="http://119.23.216.163";//当前服务器的ip
	public static String nowwww="https://119.23.216.163";//当前服务器的域名
