...
public class AppUtil  {
	...
	public static String getMyurl() throws UnknownHostException{
		...
		return "http://120.26.42.33/CXlife/app_goods/goodsDetailHtml.do";
	}
	
	//获取Ip展示地址
	public static String getuploadRootUrlIp(){
		String url = "http://120.26.42.33/FileSave/File";
	...
	public static String getuploadRootUrl(){
		...
		//String url = "D://Apache Software Foundation//Tomcat 7.0//webapps//FileSave//File//";
		String url = "C://Program Files (x86)//Apache Software Foundation//Tomcat 7.0//webapps//FileSave//File";
		return url;
